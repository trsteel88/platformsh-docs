...
As always, be sure to take a [backup](/administration/backup-and-restore.md#backups) of `old` beforehand;
...
## 7. Optional: Delete the `old` environment
